...
export const highlightStyles: Record<string, { bg: string; text: string; border: string }> = {
  ...
  current: { bg: 'rgba(251,146,60,0.18)', text: '#fb923c', border: 'rgba(251,146,60,0.35)' },
  ...
  wall: { bg: 'rgba(71,85,105,0.4)', text: '#94a3b8', border: 'rgba(71,85,105,0.6)' },
  ...
  active: { bg: 'rgba(251,146,60,0.18)', text: '#fb923c', border: 'rgba(251,146,60,0.35)' },
