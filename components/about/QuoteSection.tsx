  ...
  return (
    <div className="relative max-w-3xl mx-auto aspect-video flex items-center justify-center">
      ...
      <div className="text-center space-y-8">
        ...
        <p className="text-2xl sm:text-3xl md:text-4xl text-balance backdrop-blur-xs">
        ...
        <p className="text-sm sm:text-base md:text-lg italic text-balance backdrop-blur-xs">
          ~ Richard Branson
        </p>
      </div>
    </div>
