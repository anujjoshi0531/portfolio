...
export function MagnetBtn({ text, size = "md", children }: MagnetBtnProps) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group hover:scale-105 ring-1 ring-primary relative flex items-center justify-center bg-primary text-background hover:bg-muted hover:text-primary rounded-full transition-all",
        currentSize
      )}>
      <div
        className={cn(
